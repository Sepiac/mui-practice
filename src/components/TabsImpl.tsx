...
import { Box, Tabs, Tab, Typography, FormControl, FormHelperText, InputLabel, Input, Paper } from '@mui/material'
    ...
    <Box>
      <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
          <Tab label="Basic Form Field Validation" icon={<CheckCircleOutlineIcon />} {...a11yProps(0)} />
          <Tab label="Basic Text Content" icon={<TextSnippetIcon />} {...a11yProps(1)} />
